...
class kits_multi_website_sign_up_otp(models.Model):
    ...
    def send_otp_email(self,customer_email):
        ...
        if sign_up_otp_id:
            ...
            mail_template.sudo().send_mail(sign_up_otp_id.id,force_send=True)
    ...
    def guest_send_email(self,customer_email):
        ...
        if customer_email:
            ...
            mail_template.sudo().send_mail(res_id= record.id,force_send=True)
            return {"email_sent":True,"error": False}
        else:
    ...
    def reset_password_email(self,customer_email):
        ...
        if customer_email:
            ...
            mail_template.sudo().send_mail(res_id= customer_id.id,force_send=True)
            return {"email_sent":True,"error": False}
        else:
