...
class kits_multi_website_power_type(models.Model):
    _name = "kits.multi.website.power.type"
    _description = "Kits Multi Website Power Type"

    name = fields.Char('Name')
    is_power_glass = fields.Boolean('Is Used For Power Glass')
    website_id = fields.Many2one('kits.b2c.website','Website')
    decription = fields.Text('Decription')
    ...
    def default_get(self, fields):
        res = super(kits_multi_website_power_type, self).default_get(fields)
