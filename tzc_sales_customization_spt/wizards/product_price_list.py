...
class product_price_list(models.TransientModel):
    ...
    def print_report(self):
        ...
        datas['form'] = res
        datas['quantities']=[self.qty1,self.qty2,self.qty3,self.qty4,self.qty5]
        datas['pricelist_id']=self.price_list.id
        datas['active_model']='product.product'
        datas['active_ids']=self.ids
        datas['is_visible_title']=True
