...
class kits_assign_salesperson_wizard(models.TransientModel):
    ...
    def notify_admin_salesperson_name(self):
        ...
        for recipient in recipients:
            ...
            self.with_context(ctx).env.ref('tzc_sales_customization_spt.partner_salesperson_change_notify_admin_mail_template').sudo().send_mail(self.partner_id.id,force_send=True,email_values={'recipient_ids':[(6,0,recipient.ids)]})
