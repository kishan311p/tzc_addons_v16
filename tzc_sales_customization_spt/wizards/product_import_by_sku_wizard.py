...
class product_import_by_sku_wizard(models.TransientModel):
    ...
    def action_search(self):
        ...
        tree_view = self.env.ref('tzc_sales_customization_spt.product_import_tree_view_spt')
        form_view = self.env.ref('tzc_sales_customization_spt.product_import_form_view_spt')
