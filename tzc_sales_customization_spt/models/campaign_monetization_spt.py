...
class campaign_monetization_spt(models.Model):
    ...
    before_status_type = fields.Selection([('b2c','B2C'),('b2b_regular','B2B-Regular'),('b2b_fs','B2B-Fs')],'Status Type Before')
    after_status_type = fields.Selection([('b2c','B2C'),('b2b_regular','B2B-Regular'),('b2b_fs','B2B-Fs')],'Status Type After')
